...
-enable_idr -ENCODE3 \
-fastq1 LM059_R1.trim.fastq.gz \
-fastq2 LM063_R1.trim.fastq.gz \
-fastq3 LM111_R1.trim.fastq.gz \
-fastq4 LM101_R1.trim.fastq.gz \
-fastq5 LM107_R1.trim.fastq.gz \
-fastq6 LM112_R1.trim.fastq.gz \
-out_dir atac_0_wt \
